...
export default function Page() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-16">
      <p className="text-sm text-gray-500"><Link href="/services" className="hover:underline">Services</Link> / Exhaust</p>
      <h1 className="mt-2 text-4xl font-extrabold">Exhaust</h1>
      <p className="mt-4 text-gray-700 max-w-3xl">
        Leaks, noise, rusted sections and emission‑related repairs handled properly.
      </p>
