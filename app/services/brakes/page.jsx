...
export default function Page() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-16">
      <p className="text-sm text-gray-500"><Link href="/services" className="hover:underline">Services</Link> / Brakes</p>
      <h1 className="mt-2 text-4xl font-extrabold">Brakes</h1>
      <p className="mt-4 text-gray-700 max-w-3xl">
        From squeaks and vibrations to full pad & rotor replacements, we diagnose and fix braking issues with quality parts and proper bedding.
      </p>
