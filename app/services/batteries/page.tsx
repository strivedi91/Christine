...
export default function Page() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-16">
      <p className="text-sm text-gray-500"><Link href="/services" className="hover:underline">Services</Link> / Batteries</p>
      <h1 className="mt-2 text-4xl font-extrabold">Batteries</h1>
      <p className="mt-4 text-gray-700 max-w-3xl">
        Testing, charging system checks, and replacements with proper registration where required.
      </p>
